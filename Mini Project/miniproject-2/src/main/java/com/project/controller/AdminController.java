...
public class AdminController {
	...
	@CrossOrigin
	@PostMapping("/admins")
	public ResponseEntity<Admin> addAdminHandler( @RequestBody Admin user) throws AdminException {
	...
	public ResponseEntity<Admin> deleteadminhandler(@PathVariable("username") String username) throws AdminException{
		Admin deletedadmin=userService.deleteUser(username);
